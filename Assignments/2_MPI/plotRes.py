...
act0 = np.loadtxt(file1, delimiter=",", usecols=0, max_rows=1001)
upw0 = np.loadtxt(file1, delimiter=",", usecols=1, max_rows=1001)
qck0 = np.loadtxt(file1, delimiter=",", usecols=2, max_rows=1001)
...
act1 = np.loadtxt(file1, delimiter=",", usecols=0, max_rows=1001, skiprows=1002)
upw1 = np.loadtxt(file1, delimiter=",", usecols=1, max_rows=1001, skiprows=1002)
qck1 = np.loadtxt(file1, delimiter=",", usecols=2, max_rows=1001, skiprows=1002)
