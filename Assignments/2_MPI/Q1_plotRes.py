...
plt.plot(x, upw0, 'k:', lw=2, label="Upwind")
plt.plot(x, qck0, 'b--', lw=1.5, label="QUICK")
plt.xlabel("x", size=14)
plt.ylabel("u(t, x)", size=14)
...
fig1 = plt.gcf()
plt.show()
# fig1.savefig("./Res/Q1_a_1.png", dpi=300, bbox_inches='tight')
...
plt.plot(x, upw1, 'k:', lw=2, label="Upwind")
plt.plot(x, qck1, 'b--', lw=1.5, label="QUICK")
plt.xlabel("x", size=14)
plt.ylabel("u(t, x)", size=14)
...
fig2 = plt.gcf()
plt.show()
# fig2.savefig("./Res/Q1_a_2.png", dpi=300, bbox_inches='tight')
...
plt.plot(x, upw2, 'k:', lw=2, label="Upwind")
plt.plot(x, qck2, 'b--', lw=1.5, label="QUICK")
plt.xlabel("x", size=14)
plt.ylabel("u(t, x)", size=14)
...
fig3 = plt.gcf()
plt.show()
# fig3.savefig("./Res/Q1_a_3.png", dpi=300, bbox_inches='tight')
...
fig4 = plt.gcf()
plt.show()
# fig4.savefig("./Res/Q1_b_1.png", dpi=300, bbox_inches='tight')
...
fig5 = plt.gcf()
plt.show()
# fig5.savefig("./Res/Q1_b_2.png", dpi=300, bbox_inches='tight')
...
fig6 = plt.gcf()
plt.show()
# fig6.savefig("./Res/Q1_b_3.png", dpi=300, bbox_inches='tight')