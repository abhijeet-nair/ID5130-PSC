...
plt.figure(figsize=(8,6))
ax = plt.subplot(111)
plt.plot(np.flip(x), phivsx0s, 'r', lw=1.5, label="p = 2")
plt.plot(np.flip(x), phivsx01, 'b--', lw=1.5, label="p = 4")
plt.plot(np.flip(x), phivsx02, 'k--', lw=1.5, label="p = 8")
plt.plot(np.flip(x), phivsx03, 'g--', lw=1.5, label="Serial")
plt.xlabel("x", size=14)
plt.ylabel(r'$\phi$', size=14)
...
plt.figure(figsize=(8,6))
ax = plt.subplot(111)
plt.plot(x, phivsy0s, 'r', lw=1.5, label="p = 2")
plt.plot(x, phivsy01, 'b--', lw=1.5, label="p = 4")
plt.plot(x, phivsy02, 'k--', lw=1.5, label="p = 8")
plt.plot(x, phivsy03, 'g--', lw=1.5, label="Serial")
plt.xlabel("x", size=14)
plt.ylabel(r'$\phi$', size=14)
...
plt.figure(figsize=(8,6))
ax = plt.subplot(111)
plt.plot(x, phivsy0a, 'r', lw=1.5, label="p = 2")
plt.plot(x, phivsy01, 'b--', lw=1.5, label="p = 4")
plt.plot(x, phivsy02, 'k--', lw=1.5, label="p = 8")
plt.plot(x, phivsy03, 'g--', lw=1.5, label="Serial")
plt.xlabel("x", size=14)
